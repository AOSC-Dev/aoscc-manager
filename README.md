...
- `user/` 用户视图：登入、账号、参会注册、参会服务、参会证、胸牌定制、志愿者招募、PGP 签名、抽票投奖
- `admin/` 管理后台视图：用户列表、通知管理、签到、抽票投奖、数据库
- `util/` 功能性组件：数据库、邮件和 Telegram 发送、凭据签名和敏感信息加密、表单验证、模板渲染、缓存策略、错误页面等
- `templates/` 视图模板
    - `user/`, `admin/` 为对应模块的对应模板
