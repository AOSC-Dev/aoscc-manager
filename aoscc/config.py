...
## merch
Item = namedtuple('Item', 'name,desc,img,sku,price,cutoff,cutoff_str')
...
_tshirt_cutoff = (datetime(2025, 7, 4, 12, 0, 0), '订购将于 7 月 4 日中午 12 时截止。')
_retros = ('美商先进牌 9950 型','松山湖 920 型','西安 612 型','Santa Clara 14900 型','常熟 1901 甲型','国际商贸牌力量 11 型','星际牌 K1 型','电计算 103 型')
_other_cutoff = (datetime(2025, 7, 10, 12, 0, 0), '订购将于 7 月 10 日中午 12 时截止。')
INVENTORY = {x.name: x for x in [
    ...
    Item(
        'AOSCC 2025 贴纸集',
        '无法到场的朋友可以邮购本次的年度贴纸集，已注册的现场与会者如需额外贴纸也可购买。',
        'sticker-2025.png',
        {'': 9999}, 760, *_other_cutoff,
    ),
    Item(
        '安安与广东小精灵光栅机箱贴',
        '程序员最怕的是 bug，安安最怕的……啊→啊↘啊↑啊↗！你不要再过来了口牙！！！',
        'cockroach-grating.png',
        {'': 9999}, 390, *_other_cutoff,
    ),
    Item(
        '安安“流浪相机”主题 PVC 透卡',
        '行囊不必太满，只要带上相机和爱意，剩下的交给命运就好。走过春夏秋冬，足迹遍布四海，遇见的与错过的不断扩展这记忆的边界，唯有此行的目的从未改变：「到远方去」。',
        'anan-camera-pvc.png',
        {'': 9999}, 143, *_other_cutoff,
    ),
    Item(
        '复古处理器铭牌机箱贴',
        '我们为安同 OS 支持的 6 个处理器架构挑出了几款具有代表性（梗属性）的硬件制作了复古铭牌。<br><br>由于开模价格较高，我们选定其中三款制作了磁性冰箱贴，也可以用作机箱贴。',
        'retro-magnet.png',
        {x: 50 for x in _retros[:3]}, 1800, FAR_FUTURE, '每款限量 50 个。',
    ),
    Item(
        '复古处理器铭牌钥匙扣',
        '我们为安同 OS 支持的 6 个处理器架构挑出了几款具有代表性（梗属性）的硬件制作了复古铭牌钥匙扣。',
        'retro-keychain.png',
        {x: 9999 for x in _retros}, 235, datetime(2025, 7, 10, 12, 0, 0), '订购将于 7 月 10 日中午 12 时截止。',
    ),
    Item(
        '安安 Fumo 玩偶',
        '由社区好友 LiarOnce 委托“番茄炒蛋”社团画师 Yukata 设计的安安 Fumo 布偶，总算开始量产，走入本次元了！安安笑嘻嘻，电脑哭唧唧，快抱一只回家辟邪吧～',
        'anan-fumo.png',
        {'': 20}, 13000, FAR_FUTURE, '限量 20 个。',
    ),
]}
